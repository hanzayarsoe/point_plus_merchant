  ...
  void _withdrawPoints(BuildContext context) {
    showDialog(
      ...
      builder: (dialogContext) {
        return ConfirmBox(
          title: 'Recharge',
          body: 'Are you sure to recharge ?',
          mainActionText: 'Recharge',
          mainAction: () {
            dialogContext.pop();
            ...
            context.read<PointRequestBloc>().add(
              PointRequestEvent.requestPoint(
                points: points,
                type: RequestTransactionType.recharge,
              ),
            );
          },
                        ...
                        child: Column(
                          ...
                          children: [
                            CustomTextFormField(
                              ...
                              onChanged: (_) {
                                setState(() {
                                  if (_lessThanMinimumRequest()) {
                                    _errorText =
                                        'Less than minimum points to recharge';
                                  } else {
                                    _errorText = null;
                                  }
                                });
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      'Minimum request points is ${Formatter.formatNumber(10000)} pts!',
